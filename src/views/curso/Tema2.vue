...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-4 Toda empresa ofrece productos o servicios dirigidos hacia un cliente particular, quienes para satisfacer sus necesidades pagan una cantidad de dinero determinada, la cual es conocida como ingreso. Estos, son requisitos necesarios para continuar con el negocio, ya que determinarán la satisfacción de sus socios y la estabilidad de los colaboradores de la empresa. Por otro lado, si los ingresos de la empresa son muy altos, pero el costo de sostenimiento mayor que los ingresos, no se estaría asegurando la permanencia del negocio en el mercado.
      br
      br
      | Los egresos, por su parte, son aquellos costos y gastos que se necesitan hacer para el correcto funcionamiento de la empresa: el pago de materias primas, de servicios prestados por cada uno de los colaboradores y de aquellos elementos que apoyan constantemente el día a día de la empresa.

    .row.mb-4
      .col-auto
        .c-tarjeta--customColor.p-4.mb-5      
          p #[strong El flujo de caja representa los ingresos y egresos de la operación normal de la empresa en un periodo determinado.]

    .row.justify-content-center.align-items-center.mb-5
      .col-auto.mb-4.mb-lg-0.me-0.me-lg-5
        figure
          img(src="@/assets/tema_2/img_2_1_01.svg", alt="Flujo de caja", style="width:100%; max-width:450px;")
      .col-12.col-lg
        p.mb-3 Según las diferentes bibliografías existentes, el flujo de caja se puede llamar de diferentes formas, entre ellas están:
        ul.custom-marker
          li.mb-3 Fujo de efectivo.
          li.mb-3 Fujo de caja.
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-12.col-lg-9
        p(style="font-size:18pt").mb-4.text-center El estado de flujo de caja es especialmente valioso en proveer información de asuntos relacionados con el efectivo, como son:

    ul.custom-marker.mb-5
      li.mb-3 Capacidad de la firma o proyecto para atender las obligaciones de efectivo a corto y largo plazo.
      li.mb-3 Necesidad de financiación externa y uso de la deuda a largo plazo.
      li.mb-3 Análisis de propuestas de crédito.
      li.mb-3 Valoración de la empresa futura o del proyecto.
      li.mb-3 Habilidad del proyecto para generar el efectivo necesario para su operación.
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-12.col-lg-9
        p(style="font-size:18pt").mb-4.text-center En la construcción o elaboración de un estado de flujo de efectivo, se deben tener en cuenta los siguientes elementos básicos:

    ul.custom-marker.mb-5
      li.mb-3 Saldo inicial de efectivo.
      li.mb-3 Entradas de efectivo durante el periodo a evaluar.
      li.mb-3 Salidas de efectivo durante el periodo a evaluar.
    ...
    ul.custom-marker.mb-5
      ...
      li.mb-3 Cómo se cubrirán las necesidades de efectivo temporales sobre el capital de trabajo.
      li.mb-3 Las fuentes de financiación, y en qué se va a invertir el capital.
      li.mb-3 Cómo se invertirán los sobrantes de efectivos temporales.
      li.mb-3 Las fuentes de efectivo de la empresa y cómo se planea utilizarlas.
      li.mb-3 Las fuentes de efectivo de la empresa y cómo se planea utilizarlas.Todas las demás políticas que pueda tener la empresa y que incidan en los movimientos de efectivo. Todas las demás políticas que pueda tener la empresa y que incidan en los movimientos de efectivo. 
    ...
    .titulo-segundo.mb-5
      #t_2_2.h4 2.2 Balance inicial

    figure
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/maVbxjCWgKQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption Video: Balance inicial
